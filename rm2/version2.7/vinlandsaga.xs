...
//   rmAddObjectDefConstraint(transportAtlanteanID, playerEdgeConstraint);
   ...
   rmSetObjectDefMaxDistance(transportChineseID, 60.0);
   rmAddObjectDefConstraint(transportChineseID, transportNearShore);
//   rmAddObjectDefConstraint(transportChineseID, playerEdgeConstraint);
  ...
  // Cliff.
   ...
   for(i=0; <cNumberPlayers)
   {
      if(rmGetPlayerCulture(i) == cCultureGreek)
         ...
         rmPlaceObjectDefAtLoc(transportChineseID, i, rmPlayerLocXFraction(i), rmPlayerLocZFraction(i));
   }
