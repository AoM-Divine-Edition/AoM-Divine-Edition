...
void main(void)
{
	...
	rmAddObjectDefItem			(IDStraggler2, "marsh tree", 1, 0.0);
   ...
   rmBuildArea			(IDCenter);
	...
	rmAddConnectionTerrainReplacement	(IDShallows, "RiverMarshA", "MarshE");
	...
	rmAddConnectionTerrainReplacement	(IDExtraShallows, "RiverMarshA", "MarshE"); 
	...
	rmAddConnectionTerrainReplacement	(IDTeamShallows, "RiverMarshA", "MarshE");
	...
	for(i = 0; <bonusCount)
	{
		...
		rmSetAreaTerrainType	(IDBonusIsland, "MarshA");
		rmAddAreaTerrainLayer	(IDBonusIsland, "MarshB", 0, 6);  
	...
	for(i=1; <cNumberPlayers)
	{
		...
		rmSetAreaTerrainType	(AreaPlayerCore, "MarshD");
		rmAddAreaTerrainLayer	(AreaPlayerCore, "MarshD", 4, 7);
		rmAddAreaTerrainLayer	(AreaPlayerCore, "MarshD", 2, 4);
		rmAddAreaTerrainLayer	(AreaPlayerCore, "MarshE", 0, 2);
	}
	...
	for(i=1; <cNumberPlayers*20*mapSizeMultiplier)
	{
		...
		rmSetAreaTerrainType	(AreaMarsh, "MarshC");
	...
	for(i=1; <cNumberPlayers*20*mapSizeMultiplier)
	{
		...
		rmSetAreaTerrainType	(AreaDirt, "GrassDirt50");
		rmAddAreaTerrainLayer	(AreaDirt, "GrassDirt25", 0, 2); 
	...
	for(i = 0; < forestCount)
	{
		...
		rmSetAreaForestType		(IDForest, "Marsh forest");
		...
		rmSetAreaTerrainType	(IDForest, "MarshA");
		rmAddAreaTerrainLayer	(IDForest, "MarshB", 0, 2); 
	...
	for(i=0; <9*cNumberNonGaiaPlayers*mapSizeMultiplier)
	{
		...
		rmSetAreaForestType			(IDPlayerForest, "mixed oak forest");
	...
	rmAddObjectDefItem			(IDLog, "rotting log", rmRandInt(1,2), 0.0);
	rmAddObjectDefItem			(IDLog, "bush", 1, 2.0);
	rmAddObjectDefItem			(IDLog, "grass", rmRandInt(3,5), 2.0);
