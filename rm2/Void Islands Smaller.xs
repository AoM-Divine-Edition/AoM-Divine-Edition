...
void main(void)
{
	...
	rmxInit("Void Islands (by AProperGentleman)", false, false, false);
  ...
  // Text
   ...
   rmTerrainInitialize("Astro Tile");
   ...
   rmAddObjectDefItem(stragglerTreeID, "void tree", 1, 0.0);
   ...
   rmAddObjectDefItem(randomTreeID, "void tree", 1, 0.0);
  ...
  /*    rmSetAreaCoherence(id, 0.0); */
      ...
      // Set type.
      rmSetAreaTerrainType(id, "OlympusC");
...
rmSetAreaLocation(bonusIslandID, 0.5, 0.5);
    ...
    rmSetAreaTerrainType(bonusIslandID, "OlympusC"); 
...
/*      rmAddAreaConstraint(bonusIslandID, playerEdgeConstraint); */
   ...
   for(i=1; <realNumberPlayers*10)
   {
      ...
      rmSetAreaTerrainType(id3, "OlympusA");
...
rmPlaceObjectDefPerPlayer(farPredatorID, false);
  ...
  // Text
   ...
   for(i=1; <realNumberPlayers)
   {
      ...
      for(j=0; <forestCount)
      {
         ...
         rmSetAreaForestType(forestID, "void forest");
  ...
  // Text
   ...
   rmAddObjectDefItem(grassID, "galactic mist", 1, 1.0);
   ...
   rmAddObjectDefItem(rockID2, "skull decoration", 3, 1.0);
