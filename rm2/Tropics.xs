...
void main(void)
{
  ...
  // Text
   ...
   rmAddObjectDefItem(closePigsID, "Turkey", 2, 2.0);
   ...
   rmAddObjectDefItem(closeChickensID, "turkey", rmRandInt(7,10), 5.0);
   ...
   if(waterBuffaloNumber<0.3)
      rmAddObjectDefItem(closeWaterBuffaloID, "Guanaco", 1, 4.0);
   else if(waterBuffaloNumber<0.6)
      rmAddObjectDefItem(closeWaterBuffaloID, "Guanaco", 2, 4.0);
   else 
      rmAddObjectDefItem(closeWaterBuffaloID, "Guanaco", 3, 6.0);
   rmSetObjectDefMinDistance(closeWaterBuffaloID, 30.0);
   rmSetObjectDefMaxDistance(closeWaterBuffaloID, 50.0);

   int stragglerTreeID=rmCreateObjectDef("straggler tree");
   rmAddObjectDefItem(stragglerTreeID, "zpalmetto", 1, 0.0);
   ...
   rmAddObjectDefItem(mediumPigsID, "Turkey", 2, 4.0);
   ...
   rmAddObjectDefItem(farPigsID, "Turkey", 2, 4.0);
   ...
   if(predatorSpecies<0.5)   
      rmAddObjectDefItem(farPredatorID, "jaguar", 2, 4.0);
   else
      rmAddObjectDefItem(farPredatorID, "black panther", 1, 4.0);
   ...
   if(bonusChance<0.5)   
      rmAddObjectDefItem(bonusHuntableID, "guanaco", 4, 4.0);
   else
      rmAddObjectDefItem(bonusHuntableID, "guanaco", 6, 8.0);
   ...
   rmAddObjectDefItem(randomTreeID, "zpalmetto", 1, 0.0);
  ...
  /*    rmSetAreaCoherence(id, 0.0); */
      ...
      // Set type.
      rmSetAreaTerrainType(id, "WhiteBeachIV");
   ...
   for(i=0; <bonusCount)
   {
      ...
      rmSetAreaTerrainType(bonusIslandID, "WhiteBeachIV"); 
...
/*      rmAddAreaConstraint(bonusIslandID, playerEdgeConstraint); */
   ...
   for(i=1; <cNumberPlayers*10)
   {
      ...
      rmSetAreaTerrainType(id3, "WhiteBeachII");
  ...
  // Text
   ...
   for(i=1; <cNumberPlayers)
   {
      ...
      for(j=0; <forestCount)
      {
         ...
         rmSetAreaForestType(forestID, "AOE II forest");
