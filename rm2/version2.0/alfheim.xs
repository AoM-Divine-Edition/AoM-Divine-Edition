...
void main(void){
		...
		if(rmPlaceFairLocs()){
			for(p = 1; <= cNumberNonGaiaPlayers){
				...
				for(FL = 0; < 2){
					...
					rmAddAreaTerrainLayer(settlementArea2, "GrassA", 0, 8);
					rmAddAreaTerrainLayer(settlementArea2, "GrassDirt25", 8, 16);
					rmAddAreaTerrainLayer(settlementArea2, "GrassDirt50", 16, 24);
	...
	rmAddObjectDefItem(grassID, "grass", rmRandInt(2,6), 6.0);
	rmAddObjectDefItem(grassID, "bush", rmRandInt(2,3), 6.0);
