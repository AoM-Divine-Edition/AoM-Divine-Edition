...
void main(void){
	...
	if(rmRandFloat(0.0,1.0) > 0.01){
		...
		waterLillyID=rmCreateObjectDef("Water Lillies");
		rmAddObjectDefItem(waterLillyID, "Box Turtles", 1, 4.0);
		rmSetObjectDefMinDistance(waterLillyID, 0.1);
		rmSetObjectDefMaxDistance(waterLillyID, 0.5);
