...
void main(void)
{
   ...
   rmBuildArea			(IDCenter);
	...
	for(i = 0; <bonusCount)
	{
		...
		rmSetAreaSmoothDistance	(IDBonusIsland, 2);
	...
	for(i=1; <cNumberPlayers)
	{
		...
		rmSetAreaSize			(AreaPlayerCore, 3.5, 3.5);
		...
		rmSetAreaCoherence		(AreaPlayerCore, 3.5);
		rmSetAreaBaseHeight		(AreaPlayerCore, 2.0);
