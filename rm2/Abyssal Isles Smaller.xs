...
void main(void)
{
	...
	rmxInit("Abyssal Isles (by AProperGentleman)", false, false, false);
...
int realNumberNonGaiaPlayers = cNumberNonGaiaPlayers - 1;
  ...
  // Text
   ...
   // Set size.
   int playerTiles=12200 + 15000;
   if(cMapSize == 1)
   {
      playerTiles = 15860 + 15000;
   ...
   //Island avoidance
   int islandConstraint=rmCreateClassDistanceConstraint("islands avoid islands", classIsland, 18.0);
   ...
   rmAddObjectDefItem(randomTreeID, "dead pine", 1, 0.0);
  ...
  /*    rmSetAreaCoherence(id, 0.0); */
      ...
      // Set type.
      rmSetAreaTerrainType(id, "CoralA");
...
rmSetAreaLocation(bonusIslandID, 0.5, 0.5);
    ...
    rmSetAreaTerrainType(bonusIslandID, "CoralB"); 
   ...
   rmBuildAllAreas();
    ...
    //rmPlaceObjectDefInArea(titanID, 0,  rmAreaID("bonus island"+0), 5 );
   ...
   for(i=1; <bonusCount+1)
   {
      ...
      rmSetAreaTerrainType(bonusIslandID, "CoralA"); 
      rmSetAreaWarnFailure(bonusIslandID, false);
/*      rmAddAreaConstraint(bonusIslandID, playerEdgeConstraint); */
   ...
   for(i=1; <realNumberPlayers*250)
   {
      ...
      rmSetAreaTerrainType(id3, "CoralA");
