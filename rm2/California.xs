...
void main(void)
{
	...
	rmTerrainInitialize("cliffgreekb");
	rmSetLightingSet("noon");
	...
	rmAddObjectDefItem			(IDStartingHerd, "Turkey", rmRandInt(2,4), 2.0);
	...
	rmAddObjectDefItem			(IDStragglerTree, "ZMaple Tree", 1, 0.0);
	...
	rmAddObjectDefItem			(IDMediumHerd, "Turkey", rmRandFloat(1,2), 4.0);
	...
	rmAddObjectDefItem			(IDMediumDeer, "moose", rmRandInt(3,8), 4.0);
	...
	rmAddObjectDefItem			(IDFarHerd, "Turkey", rmRandInt(1,2), 4.0);
	...
	if(predatorSpecies<0.5)   
		rmAddObjectDefItem		(IDFarPred, "jaguar", rmRandInt(2,3), 4.0);
	else
		rmAddObjectDefItem		(IDFarPred, "bear black", 2, 4.0);
	...
	if(bonusChance < 0.33)   
		...
		rmAddObjectDefItem		(IDBonusHunt, "moose", rmRandInt(3,6), 4.0);
	else
		rmAddObjectDefItem		(IDBonusHunt, "bear grizzly", rmRandInt(2,3), 4.0);
	...
	rmAddObjectDefItem			(IDRandomTree, "ZMaple Tree", 1, 0.0);
	...
	for(i=1; <cNumberPlayers)
	{
		...
		rmSetAreaTerrainType	(AreaPlayer, "NewEnglandCliffa");
		rmAddAreaTerrainLayer	(AreaPlayer, "NewEnglandCliff", 8, 20);
		rmAddAreaTerrainLayer	(AreaPlayer, "GreekCliffb", 0, 8);
	}
	...
	for(i=1; <cNumberPlayers)
	{
		...
		rmSetAreaTerrainType	(AreaPlayerInner, "NewEnglandCliff");
	...
	for(i=1; <cNumberPlayers*20*mapSizeMultiplier)
	{
		...
		rmSetAreaTerrainType	(AreaGrass, "NewEnglandCliffa");
	...
	for(i=1; <cNumberPlayers*12*mapSizeMultiplier)
	{
		...
		rmSetAreaTerrainType	(AreaGrassDirt, "NewEnglandCliffa");
	...
	for(i=0; <numTries)
	{
		...
		rmSetAreaCliffHeight	(IDCliff, 16, 1.0, 1.5);
	...
	for(i=0; <2*cNumberNonGaiaPlayers*mapSizeMultiplier)
	{
		...
		rmSetAreaTerrainType	(IDRuin, "NewEnglandCliff");
		rmAddAreaTerrainLayer	(IDRuin, "NewEnglandCliffa", 0, 1);
		...
		rmAddObjectDefItem			(IDColumn, "ZCalifornia", rmRandInt(0,1), 0.0);
		rmAddObjectDefItem			(IDColumn, "ZSauguney", rmRandInt(2,5), 4.0);
		rmAddObjectDefItem			(IDColumn, "Zflowers", rmRandFloat(0,2), 4.0);
	...
	for(i=0; <numTries)
	{
		...
		rmSetAreaSize			(IDForest, rmAreaTilesToFraction(500*mapSizeMultiplier), rmAreaTilesToFraction(1000*mapSizeMultiplier));
		rmSetAreaWarnFailure	(IDForest, false);
		rmSetAreaForestType		(IDForest, "AOE California Forest");
